...
function load() {
    ...
    console.log("{% static 'constructor/Syndicate.json' %}")
    m_data.load("E:/Univer/Syndicate/constructor/static/constructor/assets/Syndicate.json", load_cb, null);
    //
...
function init_controls(){
	...
	document.getElementById("ready").addEventListener("click", function(e) {
		...
		for (var i = 0; i < arr.length; i++)
		{
			...
			toJson.push({name:name,x:tsr[0],y:tsr[1],z:tsr[2],s:tsr[3],qx:tsr[4],qy:tsr[5],qz:tsr[6],qw:tsr[7]});
		}
